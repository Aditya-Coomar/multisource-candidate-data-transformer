...
import type { NormalizationOperation } from './normalization-operation';
import type { Skill } from './skill';
import type { SocialLink } from './social-link';
import type { SourceRecord } from './source-record';

/**
 * Deterministic normalization output consumed by later merge stages.
 */
export interface NormalizedPartialCandidate {
...
/**
 * Creates immutable normalized candidate output.
 */
export function createNormalizedPartialCandidate(
  input: Partial<NormalizedPartialCandidate> = {},
  ...
  return Object.freeze({
    ...
    normalizationOperations: Object.freeze([
      ...(input.normalizationOperations ?? []),
    ]),
  });
}
